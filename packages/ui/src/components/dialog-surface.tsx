...
const SURFACE_CLASS =
	"flex max-h-[calc(100dvh-3rem)] w-128 max-w-[calc(100vw-3rem)] flex-col gap-4 overflow-y-auto rounded-2xl p-6 sm:max-w-[calc(100vw-3rem)] [&>[data-slot=dialog-title]+[data-slot=dialog-description]]:-mt-3"

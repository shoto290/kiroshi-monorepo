...
const SURFACE = `relative my-2 me-2 flex min-w-0 flex-1 flex-col overflow-hidden rounded-xl border border-border bg-background ${YIELDS_TO_TRAILING_PANEL} ${YIELDS_TO_NESTED_CARD}`
